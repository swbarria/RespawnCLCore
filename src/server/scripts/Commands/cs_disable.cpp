...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "spell",                  SEC_DEVELOPER,      true,   &HandleRemoveDisableSpellCommand,               "", NULL },
            { "quest",                  SEC_DEVELOPER,      true,   &HandleRemoveDisableQuestCommand,               "", NULL },
            { "map",                    SEC_DEVELOPER,      true,   &HandleRemoveDisableMapCommand,                 "", NULL },
            { "battleground",           SEC_DEVELOPER,      true,   &HandleRemoveDisableBattlegroundCommand,        "", NULL },
            { "achievement_criteria",   SEC_DEVELOPER,      true,   &HandleRemoveDisableAchievementCriteriaCommand, "", NULL },
            { "outdoorpvp",             SEC_DEVELOPER,      true,   &HandleRemoveDisableOutdoorPvPCommand,          "", NULL },
            { "vmap",                   SEC_DEVELOPER,      true,   &HandleRemoveDisableVmapCommand,                "", NULL },
            { NULL,                     0,                      false,  NULL,                                           "", NULL }
        };
        static ChatCommand addDisableCommandTable[] =
        {
            { "spell",                  SEC_DEVELOPER,      true,   &HandleAddDisableSpellCommand,                  "", NULL },
            { "quest",                  SEC_DEVELOPER,      true,   &HandleAddDisableQuestCommand,                  "", NULL },
            { "map",                    SEC_DEVELOPER,      true,   &HandleAddDisableMapCommand,                    "", NULL },
            { "battleground",           SEC_DEVELOPER,      true,   &HandleAddDisableBattlegroundCommand,           "", NULL },
            { "achievement_criteria",   SEC_DEVELOPER,      true,   &HandleAddDisableAchievementCriteriaCommand,    "", NULL },
            { "outdoorpvp",             SEC_DEVELOPER,      true,   &HandleAddDisableOutdoorPvPCommand,             "", NULL },
            { "vmap",                   SEC_DEVELOPER,      true,   &HandleAddDisableVmapCommand,                   "", NULL },
            { NULL,                     0,                      false,  NULL,                                           "", NULL }
        };
