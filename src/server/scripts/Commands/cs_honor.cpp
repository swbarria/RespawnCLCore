...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "kill",           SEC_ADMINISTRATOR,     false, &HandleHonorAddKillCommand,         "", NULL },
            { "",               SEC_ADMINISTRATOR,     false, &HandleHonorAddCommand,             "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };

        static ChatCommand honorCommandTable[] =
        {
            { "add",            SEC_ADMINISTRATOR,     false, NULL,               "", honorAddCommandTable },
            { "update",         SEC_ADMINISTRATOR,     false, &HandleHonorUpdateCommand,          "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
