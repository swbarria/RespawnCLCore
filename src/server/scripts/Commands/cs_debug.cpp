...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "buyerror",       SEC_DEVELOPER,  false, &HandleDebugSendBuyErrorCommand,       "", NULL },
            { "channelnotify",  SEC_DEVELOPER,  false, &HandleDebugSendChannelNotifyCommand,  "", NULL },
            { "chatmmessage",   SEC_DEVELOPER,  false, &HandleDebugSendChatMsgCommand,        "", NULL },
            { "equiperror",     SEC_DEVELOPER,  false, &HandleDebugSendEquipErrorCommand,     "", NULL },
            { "largepacket",    SEC_DEVELOPER,  false, &HandleDebugSendLargePacketCommand,    "", NULL },
            { "opcode",         SEC_DEVELOPER,  false, &HandleDebugSendOpcodeCommand,         "", NULL },
            { "qpartymsg",      SEC_DEVELOPER,  false, &HandleDebugSendQuestPartyMsgCommand,  "", NULL },
            { "qinvalidmsg",    SEC_DEVELOPER,  false, &HandleDebugSendQuestInvalidMsgCommand, "", NULL },
        ...
        static ChatCommand debugCommandTable[] =
        {
            ...
            { "setvalue",       SEC_DEVELOPER,  false, &HandleDebugSetValueCommand,        "", NULL },
            { "spawnvehicle",   SEC_DEVELOPER,  false, &HandleDebugSpawnVehicleCommand,    "", NULL },
            { "setvid",         SEC_DEVELOPER,  false, &HandleDebugSetVehicleIdCommand,    "", NULL },
            { "entervehicle",   SEC_DEVELOPER,  false, &HandleDebugEnterVehicleCommand,    "", NULL },
            { "uws",            SEC_DEVELOPER,  false, &HandleDebugUpdateWorldStateCommand, "", NULL },
