...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "achievement", SEC_DEVELOPER,  true,  &HandleReloadAllAchievementCommand, "", NULL },
            { "area",       SEC_DEVELOPER,  true,  &HandleReloadAllAreaCommand,       "", NULL },
            { "eventai",    SEC_DEVELOPER,  true,  &HandleReloadAllEventAICommand,    "", NULL },
            { "gossips",    SEC_DEVELOPER,  true,  &HandleReloadAllGossipsCommand,    "", NULL },
            { "item",       SEC_DEVELOPER,  true,  &HandleReloadAllItemCommand,       "", NULL },
            { "locales",    SEC_DEVELOPER,  true,  &HandleReloadAllLocalesCommand,    "", NULL },
            { "loot",       SEC_DEVELOPER,  true,  &HandleReloadAllLootCommand,       "", NULL },
            { "npc",        SEC_DEVELOPER,  true,  &HandleReloadAllNpcCommand,        "", NULL },
            { "quest",      SEC_DEVELOPER,  true,  &HandleReloadAllQuestCommand,      "", NULL },
            { "scripts",    SEC_DEVELOPER,  true,  &HandleReloadAllScriptsCommand,    "", NULL },
            { "spell",      SEC_DEVELOPER,  true,  &HandleReloadAllSpellCommand,      "", NULL },
            { "",           SEC_DEVELOPER,  true,  &HandleReloadAllCommand,           "", NULL },
            { NULL,         0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand reloadCommandTable[] =
        {
            { "auctions",                     SEC_DEVELOPER, true,  &HandleReloadAuctionsCommand,                   "", NULL },
            { "access_requirement",           SEC_DEVELOPER, true,  &HandleReloadAccessRequirementCommand,          "", NULL },
            { "achievement_criteria_data",    SEC_DEVELOPER, true,  &HandleReloadAchievementCriteriaDataCommand,    "", NULL },
            { "achievement_reward",           SEC_DEVELOPER, true,  &HandleReloadAchievementRewardCommand,          "", NULL },
            { "all",                          SEC_DEVELOPER, true,  NULL,                          "", reloadAllCommandTable },
            { "areatrigger_involvedrelation", SEC_DEVELOPER, true,  &HandleReloadQuestAreaTriggersCommand,          "", NULL },
            { "areatrigger_tavern",           SEC_DEVELOPER, true,  &HandleReloadAreaTriggerTavernCommand,          "", NULL },
            { "areatrigger_teleport",         SEC_DEVELOPER, true,  &HandleReloadAreaTriggerTeleportCommand,        "", NULL },
            { "autobroadcast",                SEC_DEVELOPER, true,  &HandleReloadAutobroadcastCommand,              "", NULL },
            { "command",                      SEC_DEVELOPER, true,  &HandleReloadCommandCommand,                    "", NULL },
            { "conditions",                   SEC_DEVELOPER, true,  &HandleReloadConditions,                        "", NULL },
            { "config",                       SEC_DEVELOPER, true,  &HandleReloadConfigCommand,                     "", NULL },
            { "creature_text",                SEC_DEVELOPER, true,  &HandleReloadCreatureText,                      "", NULL },
            { "creature_ai_scripts",          SEC_DEVELOPER, true,  &HandleReloadEventAIScriptsCommand,             "", NULL },
            { "creature_ai_summons",          SEC_DEVELOPER, true,  &HandleReloadEventAISummonsCommand,             "", NULL },
            { "creature_ai_texts",            SEC_DEVELOPER, true,  &HandleReloadEventAITextsCommand,               "", NULL },
            { "creature_involvedrelation",    SEC_DEVELOPER, true,  &HandleReloadCreatureQuestInvRelationsCommand,  "", NULL },
            { "creature_linked_respawn",      SEC_GAMEMASTER,    true,  &HandleReloadLinkedRespawnCommand,              "", NULL },
            { "creature_loot_template",       SEC_DEVELOPER, true,  &HandleReloadLootTemplatesCreatureCommand,      "", NULL },
            { "creature_onkill_reputation",   SEC_DEVELOPER, true,  &HandleReloadOnKillReputationCommand,           "", NULL },
            { "creature_questrelation",       SEC_DEVELOPER, true,  &HandleReloadCreatureQuestRelationsCommand,     "", NULL },
            { "creature_template",            SEC_DEVELOPER, true,  &HandleReloadCreatureTemplateCommand,           "", NULL },
            //{ "db_script_string",             SEC_DEVELOPER, true,  &HandleReloadDbScriptStringCommand,            "", NULL },
            { "disables",                     SEC_DEVELOPER, true,  &HandleReloadDisablesCommand,                   "", NULL },
            { "disenchant_loot_template",     SEC_DEVELOPER, true,  &HandleReloadLootTemplatesDisenchantCommand,    "", NULL },
            { "event_scripts",                SEC_DEVELOPER, true,  &HandleReloadEventScriptsCommand,               "", NULL },
            { "fishing_loot_template",        SEC_DEVELOPER, true,  &HandleReloadLootTemplatesFishingCommand,       "", NULL },
            { "game_graveyard_zone",          SEC_DEVELOPER, true,  &HandleReloadGameGraveyardZoneCommand,          "", NULL },
            { "game_tele",                    SEC_DEVELOPER, true,  &HandleReloadGameTeleCommand,                   "", NULL },
            { "gameobject_involvedrelation",  SEC_DEVELOPER, true,  &HandleReloadGOQuestInvRelationsCommand,        "", NULL },
            { "gameobject_loot_template",     SEC_DEVELOPER, true,  &HandleReloadLootTemplatesGameobjectCommand,    "", NULL },
            { "gameobject_questrelation",     SEC_DEVELOPER, true,  &HandleReloadGOQuestRelationsCommand,           "", NULL },
            { "gameobject_scripts",           SEC_DEVELOPER, true,  &HandleReloadGameObjectScriptsCommand,          "", NULL },
            { "gm_tickets",                   SEC_DEVELOPER, true,  &HandleReloadGMTicketsCommand,                  "", NULL },
            { "gossip_menu",                  SEC_DEVELOPER, true,  &HandleReloadGossipMenuCommand,                 "", NULL },
            { "gossip_menu_option",           SEC_DEVELOPER, true,  &HandleReloadGossipMenuOptionCommand,           "", NULL },
            { "item_enchantment_template",    SEC_DEVELOPER, true,  &HandleReloadItemEnchantementsCommand,          "", NULL },
            { "item_loot_template",           SEC_DEVELOPER, true,  &HandleReloadLootTemplatesItemCommand,          "", NULL },
            { "item_set_names",               SEC_DEVELOPER, true,  &HandleReloadItemSetNamesCommand,               "", NULL },
            { "lfg_dungeon_rewards",          SEC_DEVELOPER, true,  &HandleReloadLfgRewardsCommand,                 "", NULL },
            { "locales_achievement_reward",   SEC_DEVELOPER, true,  &HandleReloadLocalesAchievementRewardCommand,   "", NULL },
            { "locales_creature",             SEC_DEVELOPER, true,  &HandleReloadLocalesCreatureCommand,            "", NULL },
            { "locales_creature_text",        SEC_DEVELOPER, true,  &HandleReloadLocalesCreatureTextCommand,        "", NULL },
            { "locales_gameobject",           SEC_DEVELOPER, true,  &HandleReloadLocalesGameobjectCommand,          "", NULL },
            { "locales_gossip_menu_option",   SEC_DEVELOPER, true,  &HandleReloadLocalesGossipMenuOptionCommand,    "", NULL },
            { "locales_item",                 SEC_DEVELOPER, true,  &HandleReloadLocalesItemCommand,                "", NULL },
            { "locales_item_set_name",        SEC_DEVELOPER, true,  &HandleReloadLocalesItemSetNameCommand,         "", NULL },
            { "locales_npc_text",             SEC_DEVELOPER, true,  &HandleReloadLocalesNpcTextCommand,             "", NULL },
            { "locales_page_text",            SEC_DEVELOPER, true,  &HandleReloadLocalesPageTextCommand,            "", NULL },
            { "locales_points_of_interest",   SEC_DEVELOPER, true,  &HandleReloadLocalesPointsOfInterestCommand,    "", NULL },
            { "locales_quest",                SEC_DEVELOPER, true,  &HandleReloadLocalesQuestCommand,               "", NULL },
            { "mail_level_reward",            SEC_DEVELOPER, true,  &HandleReloadMailLevelRewardCommand,            "", NULL },
            { "mail_loot_template",           SEC_DEVELOPER, true,  &HandleReloadLootTemplatesMailCommand,          "", NULL },
            { "milling_loot_template",        SEC_DEVELOPER, true,  &HandleReloadLootTemplatesMillingCommand,       "", NULL },
            { "npc_spellclick_spells",        SEC_DEVELOPER, true,  &HandleReloadSpellClickSpellsCommand,           "", NULL},
            { "npc_trainer",                  SEC_DEVELOPER, true,  &HandleReloadNpcTrainerCommand,                 "", NULL },
            { "npc_vendor",                   SEC_DEVELOPER, true,  &HandleReloadNpcVendorCommand,                  "", NULL },
            { "page_text",                    SEC_DEVELOPER, true,  &HandleReloadPageTextsCommand,                  "", NULL },
            { "pickpocketing_loot_template",  SEC_DEVELOPER, true,  &HandleReloadLootTemplatesPickpocketingCommand, "", NULL},
            { "points_of_interest",           SEC_DEVELOPER, true,  &HandleReloadPointsOfInterestCommand,           "", NULL },
            { "prospecting_loot_template",    SEC_DEVELOPER, true,  &HandleReloadLootTemplatesProspectingCommand,   "", NULL },
            { "quest_end_scripts",            SEC_DEVELOPER, true,  &HandleReloadQuestEndScriptsCommand,            "", NULL },
            { "quest_poi",                    SEC_DEVELOPER, true,  &HandleReloadQuestPOICommand,                   "", NULL },
            { "quest_start_scripts",          SEC_DEVELOPER, true,  &HandleReloadQuestStartScriptsCommand,          "", NULL },
            { "quest_template",               SEC_DEVELOPER, true,  &HandleReloadQuestTemplateCommand,              "", NULL },
            { "reference_loot_template",      SEC_DEVELOPER, true,  &HandleReloadLootTemplatesReferenceCommand,     "", NULL },
            { "reserved_name",                SEC_DEVELOPER, true,  &HandleReloadReservedNameCommand,               "", NULL },
            { "reputation_reward_rate",       SEC_DEVELOPER, true,  &HandleReloadReputationRewardRateCommand,       "", NULL },
            { "reputation_spillover_template", SEC_DEVELOPER, true,  &HandleReloadReputationRewardRateCommand,       "", NULL },
            { "skill_discovery_template",     SEC_DEVELOPER, true,  &HandleReloadSkillDiscoveryTemplateCommand,     "", NULL },
            { "skill_extra_item_template",    SEC_DEVELOPER, true,  &HandleReloadSkillExtraItemTemplateCommand,     "", NULL },
            { "skill_fishing_base_level",     SEC_DEVELOPER, true,  &HandleReloadSkillFishingBaseLevelCommand,      "", NULL },
            { "skinning_loot_template",       SEC_DEVELOPER, true,  &HandleReloadLootTemplatesSkinningCommand,      "", NULL },
            { "smart_scripts",                SEC_DEVELOPER, true,  &HandleReloadSmartScripts,                      "", NULL },
            { "spell_required",               SEC_DEVELOPER, true,  &HandleReloadSpellRequiredCommand,              "", NULL },
            { "spell_area",                   SEC_DEVELOPER, true,  &HandleReloadSpellAreaCommand,                  "", NULL },
            { "spell_bonus_data",             SEC_DEVELOPER, true,  &HandleReloadSpellBonusesCommand,               "", NULL },
            { "spell_group",                  SEC_DEVELOPER, true,  &HandleReloadSpellGroupsCommand,                "", NULL },
            { "spell_learn_spell",            SEC_DEVELOPER, true,  &HandleReloadSpellLearnSpellCommand,            "", NULL },
            { "spell_loot_template",          SEC_DEVELOPER, true,  &HandleReloadLootTemplatesSpellCommand,         "", NULL },
            { "spell_linked_spell",           SEC_DEVELOPER, true,  &HandleReloadSpellLinkedSpellCommand,           "", NULL },
            { "spell_pet_auras",              SEC_DEVELOPER, true,  &HandleReloadSpellPetAurasCommand,              "", NULL },
            { "spell_proc_event",             SEC_DEVELOPER, true,  &HandleReloadSpellProcEventCommand,             "", NULL },
            { "spell_proc",                   SEC_DEVELOPER, true,  &HandleReloadSpellProcsCommand,                 "", NULL },
            { "spell_scripts",                SEC_DEVELOPER, true,  &HandleReloadSpellScriptsCommand,               "", NULL },
            { "spell_target_position",        SEC_DEVELOPER, true,  &HandleReloadSpellTargetPositionCommand,        "", NULL },
            { "spell_threats",                SEC_DEVELOPER, true,  &HandleReloadSpellThreatsCommand,               "", NULL },
            { "spell_group_stack_rules",      SEC_DEVELOPER, true,  &HandleReloadSpellGroupStackRulesCommand,       "", NULL },
            { "trinity_string",               SEC_DEVELOPER, true,  &HandleReloadTrinityStringCommand,              "", NULL },
            { "warden_action",                SEC_DEVELOPER, true,  &HandleReloadWardenactionCommand,               "", NULL },
            { "waypoint_scripts",             SEC_DEVELOPER, true,  &HandleReloadWpScriptsCommand,                  "", NULL },
            { "waypoint_data",                SEC_DEVELOPER, true,  &HandleReloadWpCommand,                         "", NULL },
            { "vehicle_accessory",            SEC_DEVELOPER, true,  &HandleReloadVehicleAccessoryCommand,           "", NULL },
            { "vehicle_template_accessory",   SEC_DEVELOPER, true,  &HandleReloadVehicleTemplateAccessoryCommand,   "", NULL },
            { NULL,                           0,                 false, NULL,                                           "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "reload",         SEC_DEVELOPER,  true,  NULL,                 "", reloadCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
